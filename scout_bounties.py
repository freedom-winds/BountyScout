...
def create_github_issue(repo_fullname, token, title, body):
    ...
    # Sanitize the title to fix common typos like "Opportunityies"
    title = title.replace("Opportunityies", "Opportunities") # Added line to fix typo
    ...
    try:
        ...
        # Corrected the print statement syntax for proper error logging
