...
def format_bounty_alert_title(num_opportunities):
    """
    Formats the title for a new bounty alert, including the count of new opportunities.
    Example: "🎯 Bounty Alert: 1 New Opportunity found"
    Example: "🎯 Bounty Alert: 10 New Opportunities found"
    """
    opportunity_word = "Opportunity" if num_opportunities == 1 else "Opportunities"
    return f"🎯 Bounty Alert: {num_opportunities} New {opportunity_word} found"
