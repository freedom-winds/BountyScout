...
def format_bounty_alert_title(count: int) -> str:
    """Formats a consistent title for new bounty alerts, handling pluralization correctly.
    
    Example:
    - format_bounty_alert_title(1) -> "🎯 Bounty Alert: 1 New Opportunity found"
    - format_bounty_alert_title(2) -> "🎯 Bounty Alert: 2 New Opportunities found"
    """
    if count == 1:
