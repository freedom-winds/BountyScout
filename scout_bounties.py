...
def create_github_issue(repo_fullname, token, title, body):
    ...
    # Fix a common typo in bounty alert titles if present.
    # The issue description '🎯 Bounty Alert: 11 New Opportunityies found'
    # indicates a grammatical error in the word 'Opportunityies'.
