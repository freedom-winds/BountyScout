...
# Template for the bounty alert title, correcting the typo "Opportunityies" to "Opportunities"
BOUNTY_ALERT_TITLE_TEMPLATE = "🎯 Bounty Alert: {count} New Opportunities found"
