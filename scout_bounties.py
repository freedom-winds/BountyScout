...
def create_github_issue(repo_fullname, token, title, body):
    ...
    corrected_title = title.replace("Opportunityies", "Opportunities").replace("opportunityies", "opportunities")
    ...
    try:
        ...
        # Corrected malformed print statement and provided a more descriptive error message
