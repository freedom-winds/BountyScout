...
class TestBountyScout(unittest.TestCase):
    ...
    def test_get_opportunity_text_singular_and_plural(self):
        # Singular lower and title case
        self.assertEqual(get_opportunity_text(1, title_case=False), "opportunity")
        self.assertEqual(get_opportunity_text(1, title_case=True), "Opportunity")

        # Plural lower and title case
        self.assertEqual(get_opportunity_text(0, title_case=False), "opportunities")
        self.assertEqual(get_opportunity_text(0, title_case=True), "Opportunities")
        self.assertEqual(get_opportunity_text(2, title_case=False), "opportunities")
        self.assertEqual(get_opportunity_text(2, title_case=True), "Opportunities")
        self.assertEqual(get_opportunity_text(10, title_case=False), "opportunities")
        self.assertEqual(get_opportunity_text(10, title_case=True), "Opportunities")

    def test_is_clean_candidate_filters_pull_requests(self):
        pr_item = {
            "title": "Fix memory leak in validator",
            "body": "Resolves memory leak",
            "html_url": "https://github.com/stellar/soroban-cli/pull/123",
            "pull_request": {"url": "https://api.github.com/repos/stellar/soroban-cli/pulls/123"},
            "assignees": [],
            "comments": 2,
            "state": "open"
        }
    ...
    def test_is_clean_candidate_filters_closed_or_locked(self):
        closed_item = {
            ...
            "body": "Oracle bounty details",
            "html_url": "https://github.com/stellar/oracle/issues/10",
            "assignees": [],
            "comments": 1,
            "state": "closed"
        }
        ...
        locked_item = {
            "title": "Build oracle integration",
            "body": "Oracle bounty details",
            "html_url": "https://github.com/stellar/oracle/issues/11",
            "assignees": [],
            "comments": 1,
            "state": "open",
            "locked": True
    ...
    def test_is_clean_candidate_filters_assigned(self):
        assigned_item = {
            "title": "Add telemetry exporter",
            "body": "Need prometheus exporter",
            "html_url": "https://github.com/stellar/telemetry/issues/45",
    ...
    def test_is_clean_candidate_filters_spam_blocklist(self):
        spam_samples = [
            ...
            ("Fill out our ecosystem survey", "Complete survey to get paid"),
            ("Join community ambassador program", "Become an ambassador")
        ]
