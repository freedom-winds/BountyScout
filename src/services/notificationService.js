...
async function sendBountyAlert(opportunities, notificationConfig = {}) {
  ...
  try {
    ...
    console.log(`Successfully sent notification for ${count} opportunities`);
  } catch (error) {
...
function formatNotificationMessage(opportunities) {
  ...
  let message = displayOpportunities
    .map((opp, index) => {
...
async function sendNotification(notification) {
  ...
  // This is a placeholder that can be extended based on the project's needs
