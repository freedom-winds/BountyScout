...
class TestScoutBounties(unittest.TestCase):
    """Test suite verifying bounty scouting logic, formatting, and filtering."""

    def test_pluralize_opportunity(self):
        """Verify singular and plural generation for opportunity words."""
    ...
    def test_is_clean_candidate_filters_pull_requests(self):
        """Verify candidate rejection when the item is a pull request."""
        pr_item = {
    ...
    def test_is_clean_candidate_filters_assigned(self):
        """Verify candidate rejection when issue has active assignees."""
        assigned_item = {
    ...
    def test_is_clean_candidate_filters_closed_and_locked(self):
        """Verify candidate rejection when issue is closed or locked."""
        closed_item = {
    ...
    def test_is_clean_candidate_filters_overcrowded(self):
        """Verify candidate rejection when comments exceed threshold."""
        crowded_item = {
    ...
    def test_is_clean_candidate_filters_recursive_bountyscout_and_alerts(self):
        """Verify candidate rejection for recursive alerts and forks."""
        bs_item_1 = {
            "title": "🎯 Bounty Alert: 8 New Opportunityies found",
            "body": "Active bounty scan results",
            "html_url": "https://github.com/freedom-winds/BountyScout/issues/1119",
            "assignees": [],
            "comments": 0,
            "state": "open",
        }
    ...
    def test_is_clean_candidate_filters_spam_blocklist(self):
        """Verify candidate rejection for spam keywords across title and body."""
        spam_samples = [
    ...
    def test_is_clean_candidate_accepts_valid_bounty(self):
        """Verify qualified candidates pass inspection."""
        valid_item = {
    ...
    def test_is_clean_candidate_handles_non_dict_and_none_fields(self):
        """Verify handling of non-dictionary inputs and None or missing fields."""
        self.assertFalse(is_clean_candidate(None))
        self.assertFalse(is_clean_candidate("not a dict"))
        self.assertFalse(is_clean_candidate(123))
    ...
    def test_state_persistence(self):
        """Verify reading, writing, and corrupt state handling."""
    ...
    def test_build_notification_markdown(self):
        """Verify markdown notification construction with correct grammar."""
    ...
    def test_build_github_issue_payload(self):
        """Verify issue title and body formatting with correct pluralization."""
        now_str = "2026-08-29 12:00 UTC"
