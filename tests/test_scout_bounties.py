...
class TestBountyScout(unittest.TestCase):
    ...
    def test_pluralize_opportunity(self):
        ...
        self.assertEqual(pluralize_opportunity(10, capitalize=False), "opportunities")
    ...
    def test_is_clean_candidate_filters_pull_requests(self):
        item = {
            ...
            "html_url": "https://github.com/stellar/rs-soroban-env/pull/123",
            "pull_request": {"url": "https://api.github.com/repos/stellar/rs-soroban-env/pulls/123"},
            "assignees": [],
            "comments": 2,
            "state": "open"
        }
    ...
    def test_is_clean_candidate_filters_closed_and_locked(self):
        closed_item = {
            "title": "Implement multi-sig wallet bounty",
            "body": "Need a multi-sig wallet contract",
            "html_url": "https://github.com/stellar/stellar-wallet/issues/45",
            "assignees": [],
            "comments": 1,
            "state": "closed"
        }
        ...
        locked_item = {
            "title": "Implement bridge relayer bounty",
            "body": "Need bridge relayer",
            "html_url": "https://github.com/stellar/bridge/issues/99",
            "assignees": [],
            "comments": 1,
            "state": "open",
            "locked": True
    ...
    def test_is_clean_candidate_filters_assigned(self):
        assigned_item = {
            "title": "Bounty for frontend dashboard",
            "body": "Looking for frontend developer",
            "html_url": "https://github.com/some-org/frontend/issues/10",
    ...
    def test_is_clean_candidate_filters_recursive_bountyscout_and_alerts(self):
        ...
        bs_item_1 = {
            ...
            "html_url": "https://github.com/freedom-winds/BountyScout/issues/906",
            "assignees": [],
            "comments": 0,
            "state": "open"
        }
        ...
        bs_item_2 = {
            ...
            "body": "Active bounty scan results",
            "html_url": "https://github.com/vansh-09/BountyScout/issues/974",
            "assignees": [],
            "comments": 0,
            "state": "open"
        }
