...
describe('formatBountyAlertTitle', () => {
  test('should format title correctly for 1 opportunity', () => {
  ...
  test('should format title correctly for 0 opportunities', () => {
    const result = formatBountyAlertTitle(0);
    expect(result).toBe('🎯 Bounty Alert: No new opportunities found');
  });

  test('should format title correctly for large numbers', () => {
